 ...
 *
 * @deprecated 1.5.5.4
 * @deprecated use plugin SEO Premium
 * @see SEO Premium
 *
...
function wpseo_sitemap_handler( $atts ) {
	_deprecated_function( __FUNCTION__, 'WPSEO 1.5.5.4', 'Functionality has been discontinued after being in beta, it\'ll be available in the SEO Premium plugin soon.' );
	return '';
}
