...
if (!class_exists('WPSEO_Admin')) {
	...
	class WPSEO_Admin {
		...
		function register_settings_page() {
			...
			// Add main page
			$admin_page = add_menu_page(__('WordPress SEO:', 'wordpress-seo').' '.__('General Settings', 'wordpress-seo'), __('SEO', 'wordpress-seo'), 'manage_options', 'wpseo_dashboard', array(
					$this,
					'load_page',
				), $icon_svg, '99.31337');
			...
			if (count($submenu_pages)) {
				foreach ($submenu_pages as $submenu_page) {
					...
					// Add submenu page
					$admin_page = add_submenu_page($submenu_page[0], $submenu_page[2].' - '.__('WordPress SEO:', 'wordpress-seo'), $submenu_page[2], $submenu_page[3], $submenu_page[4], $submenu_page[5]);
		...
		function register_network_settings_page() {
			if (WPSEO_Options::grant_access()) {
				// Base 64 encoded SVG image
				$icon_svg = 'data:image/svg+xml;base64,';
				add_menu_page(__('WordPress SEO:', 'wordpress-seo').' '.__('MultiSite Settings', 'wordpress-seo'), __('SEO', 'wordpress-seo'), 'delete_users', 'wpseo_dashboard', array(
						$this,
						'network_config_page',
					), $icon_svg);

				if (wpseo_allow_system_file_edit() === true) {
					add_submenu_page('wpseo_dashboard', __('WordPress SEO:', 'wordpress-seo').' '.__('Edit Files', 'wordpress-seo'), __('Edit Files', 'wordpress-seo'), 'delete_users', 'wpseo_files', array(
							$this,
							'load_page',
						));
				}
				...
				// Add Extension submenu page
				add_submenu_page('wpseo_dashboard', __('WordPress SEO:', 'wordpress-seo').' '.__('Extensions', 'wordpress-seo'), __('Extensions', 'wordpress-seo'), 'delete_users', 'wpseo_licenses', array(
						$this,
						'load_page',
					));
			}
		...
		function remove_transients_on_update($response) {
			...
			$results = $wpdb->get_results(
				"
					SELECT option_name
					FROM   {$wpdb->options}WHERE  option_name LIKE '%_transient_wpseo_sitemap_cache%'
"
			);
