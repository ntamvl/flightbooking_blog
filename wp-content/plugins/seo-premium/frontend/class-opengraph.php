	...
	class WPSEO_OpenGraph extends WPSEO_Frontend {
		...
		public function locale( $echo = true ) {
			...
			$fb_valid_fb_locales = array(
					'ca_ES', 'cs_CZ', 'cy_GB', 'da_DK', 'de_DE', 'eu_ES', 'en_PI', 'en_UD', 'ck_US', 'vi_VN', 'es_LA', 'es_CL', 'es_CO', 'es_ES', 'es_MX',
			...
			// check to see if the locale is a valid FB one, if not, use vi_VN as a fallback
			// check to see if the locale is a valid FB one, if not, use vi_VN as a fallback
