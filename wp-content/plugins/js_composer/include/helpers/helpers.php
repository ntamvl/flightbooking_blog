	...
	if ( preg_match( '/^(\d{1,2})\/12$/', $width, $match ) ) {
		...
		switch ( $width ) {
			...
			case "4/8" :
			  ...
			  break;
			case "6/8" :
			    $w = "vc_main_col one_side";
			  break;
			case "2/8" :
			    $w = "vc_sec_sidebar sidebar secondary-sidebar";
			  break;
			case "3/9" :
			    $w = "vc_sidebar sidebar main-sidebar";
			  break;
			
			//left sidebar
			case "8/8" :
			      $w = "vc_sidebar sidebar main-sidebar alignlefti";
			  break;
			case "7/7" :
			    $w = "vc_main_col one_side alignrighti";
			    break;
			case "9/9" :
			    $w = "vc_sec_sidebar sidebar secondary-sidebar alignlefti";
			    break;
