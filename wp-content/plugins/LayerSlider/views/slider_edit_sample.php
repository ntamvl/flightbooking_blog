						...
						<table class="noborder">
							...
							<tr>
								<td colspan="3">
									...
									<button class="button ls-layer-duplicate"><span class="dashicons dashicons-admin-page"></span><?php _e('Duplicate this slide', 'LayerSlider') ?></button>
								</td>
							</tr>
						</table>
					</td>
									...
									<table>
										<tbody>
											...
											<tr>
												...
												<td colspan="6"><button class="button duplicate" data-help="<?php _e('If you would like to use similar settings for other layers or to experiment on a copy, you can duplicate this layer.', 'LayerSlider') ?>"><?php _e('Duplicate this layer', 'LayerSlider') ?></button></td>
											</tr>
									</table>
								</div>
