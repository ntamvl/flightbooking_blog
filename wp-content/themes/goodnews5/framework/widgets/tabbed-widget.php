...
function mom_tabbed_init() {
    register_sidebar(array('name' => 'Tabbed Widget', 'description' => 'Default Tabbed Widget sidebar, you can add you custom one with custom sidebars.', 'class' => 'mom_tabbed_widget_container'));
