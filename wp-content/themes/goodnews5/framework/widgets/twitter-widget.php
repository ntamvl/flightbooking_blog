...
class mom_widget_twitter extends WP_Widget {
	function mom_widget_twitter() {
		...
		$this->WP_Widget('momizatTwitter',__('Momizat - Twitter','theme'),$widget_ops);
				...
				?>
					...
					<?php echo $txt; ?>
                                   ...
                                   <ul class="twiter-buttons">
                                        ...
                                        <li class="retweet"><a href="<?php echo esc_url( 'https://twitter.com/intent/retweet?tweet_id=' . $tweet_id ); ?>" onclick="window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=455,width=600');return false">Retweet</a></li>
                                        <li class="favorite"><a href="<?php echo esc_url( 'https://twitter.com/intent/favorite?tweet_id=' . $tweet_id ); ?>" onclick="window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=455,width=600');return false">Favorite</a></li>
                                   </ul>
                                </li>
				<?php
					if (++$i == $count) break;
