	...
	array( 
      ...
      if ($r->have_posts()) :
			...
			$r->the_post();
							...
							$output.= "><div class='subcat-thumbnail'><a href='".get_permalink()."' title='".get_the_title()."'><img src='".mom_post_image($img_size)."' alt='".get_the_title()."' width='".$imgw."' height='".$imgh."'></a></div><div class='subcat-title'><a href='".get_permalink()."' title='".get_the_title()."'> ".get_the_title()."</a><span> ".$sep." ". human_time_diff( get_the_time('U'), current_time('timestamp') ) ." " . __('ago', 'theme'). "</span></div></li>";
			} 
