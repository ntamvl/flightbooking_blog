...
<form class="shipping_calculator last" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<div class="main-title"><h4><a href="#" class="shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <i class="enotype-icon-arrow-down2"></i></a></h4></div>
